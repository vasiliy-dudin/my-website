...
{% projectSection "My teams and projects" %}
...
{% projectSection "Case study from Oppty" %}
...
{% projectSection "Этапы нахождения решения" %}
...
{% projectSection "1. Погружение в проблему, исследования и анализ" %}
...
{% projectSection "2. Поиск идей" %}	1. Составил список возможных паттернов для решения подобных задач. Источники: другие сервисы Semrush, каталоги UX-паттернов и известные сайты.
...
{% projectSection "3. Прототипирование и проверка решений" %}
...
{% projectSection "4. Передача на следующие этапы разработки" %}
...
{% projectSection "5. Сопровождение разработки" %}
...
{% projectSection "6. Проверка успешности решения" %}
